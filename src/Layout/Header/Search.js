...
export default function Search() {
  return (
    <label className="flex  flex-row items-center justify-center  h-[24px]  md:h-[48px] border-[2px] px-[25px] rounded-[50px]  border-Border w-full">
  ...
  text-base font-normal"
      ...
      <div className="hidden md:flex flex-row items-center justify-center gap-[10px] pl-8">
